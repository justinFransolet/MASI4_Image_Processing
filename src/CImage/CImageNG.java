...
public class CImageNG extends CImage implements Cloneable {
    ...
    public CImageNG(int[][] matrice) throws CImageNGException
    {
        ...
        catch (CImageNGException ex) { throw new CImageNGException("Erreur interne inexpliquée..."); }
    }
    ...
    public CImageNG clone() {
        try
        {
            CImageNG copy = (CImageNG) super.clone();

            BufferedImage imgCopy = new BufferedImage(
                    largeur, hauteur, BufferedImage.TYPE_INT_ARGB
            );
            ...
            copy.image = imgCopy;
            copy.contexte = imgCopy.getGraphics();
            copy.observer = null;
            return copy;
        }
    ...
    public int getPixel(int x,int y) throws CImageNGException
    {
        ...
        try 
        {
            ...
            // rouge, vert, bleu, c'est pareil !
            return cm.getRed(pixels[0]);
        } 
        catch (InterruptedException ex) 
        {
            throw new CImageNGException("Problème avec PixelGrabber");
        }
    }
    ...
    public CImageRGB getCImageRGB()
    {
        try 
        {
            ...
            return new CImageRGB(matrice,matrice,matrice);
        } 
        catch (CImageNGException | CImageRGBException ex) { System.err.println("Erreur interne inexpliqué..."); }
        return null;
    }
}
